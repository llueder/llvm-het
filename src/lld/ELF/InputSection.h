...
public:
  ...
  bool originatesFromGroupSection;
  ...
  // Was this section assigned to an variant
  Variant * variant = nullptr;
  int      variant_row = -1;
  int      variant_col = -1;
  uint32_t addend = 0; // Filler bytes added to this section when written to the ELF
...
#ifdef _WIN32
static_assert(sizeof(InputSection) <= 216, "InputSection is too big");
#else
static_assert(sizeof(InputSection) <= 216, "InputSection is too big");
#endif
